...
class Page_animation_Public {
	...
	public function enqueue_styles() {
		...
		wp_register_style( 'page_animation-public.css',  plugin_dir_url( __FILE__ ) . 'css/page_animation-public.css', array(), null, 'all' );
		wp_register_style( 'animate.css',  plugin_dir_url( __FILE__ ) . 'css/animate.css', array(), null, 'all' );
		wp_enqueue_style( 'animate.css' );
		wp_enqueue_style( 'page_animation-public.css' );
	}
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/page_animation-public.js', array( 'jquery' ), $this->version, false );
	}
